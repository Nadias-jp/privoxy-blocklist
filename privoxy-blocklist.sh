...
#    debug "... all domainbased filterfiles created ..." 1
    ...
    install -o ${PRIVOXY_USER} -g ${PRIVOXY_GROUP} -m 644 ${VERBOSE} ${actionfile} ${PRIVOXY_DIR}
    ...
    then
      ...
      install -o root -g root -m 644 ${VERBOSE} ${TMPDIR}/config ${PRIVOXY_CONF}
      debug "... installation done\n" 0
    fi	

    # install Privoxy filterfile
    install -o ${PRIVOXY_USER} -g ${PRIVOXY_GROUP} -m 644 ${VERBOSE} ${filterfile} ${PRIVOXY_DIR}
